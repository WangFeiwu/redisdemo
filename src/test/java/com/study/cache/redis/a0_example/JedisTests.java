...
public class JedisTests {
    ...
    public void list() {
        ...
        jedis.rpush("queue_1", "4", "5", "6");
        List<String> strings1 = jedis.lrange("queue_1", 0, -1);
    ...
    public void hashTest() {
        ...
        Jedis jedis = new Jedis("192.168.1.2", 6379);
        jedis.hset("user_1001", "name", "Tony");
        jedis.hset("user_1001", "age", "18");
        jedis.hset("user_1001", "userId", "1001");
        System.out.println(jedis.hgetAll("user_1001"));
        jedis.close();
    }
